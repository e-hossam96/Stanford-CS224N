...
if __name__ == '__main__':
    ...
    if args.function == 'pretrain':
        ...
        tconf = trainer.TrainerConfig(
            max_epochs=650, batch_size=128, learning_rate=6e-3,
        ...
        if args.reading_params_path != None:
            ...
            tconf = trainer.TrainerConfig(
                max_epochs=10, batch_size=512, learning_rate=6e-4, lr_decay=True, warmup_tokens=512*20, 
                final_tokens=2*len(pretrain_dataset)*block_size, num_workers=4
            )
        else:
            tconf = trainer.TrainerConfig(
                max_epochs=75, batch_size=512, learning_rate=6e-4, lr_decay=True, warmup_tokens=512*20, 
                final_tokens=2*len(pretrain_dataset)*block_size, num_workers=4
            )
